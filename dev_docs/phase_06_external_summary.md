...
| 2026-06-21 | `.venv/bin/python -B tools/pcode_slicegraph_v8_phase1.py samples/low_pcode output/v8_byte_lane_risky_gate2 expected --cases case_DFB001 case_DFB003 case_DFB007 case_DFB046 case_DFB048 case_DFB049 case_DFB120 case_DFB121 case_DFB122 case_DFB123` | PASS 60 | Byte-lane narrowing preserves external/interprocedural `call_out_mem` provenance for DFB122 while keeping DFB120/121/123 stable |
| 2026-06-21 | `.venv/bin/python -B tools/pcode_slicegraph_v8_phase1.py samples/low_pcode output/v8_bitfield_probe5 expected --cases case_DFB034 case_DFB035` | PASS 12 | Bitfield read-modify-write precision passes across x86/x64/AArch64/ARMv7 roots |
| 2026-06-21 | `.venv/bin/python -B tools/pcode_slicegraph_v8_phase1.py samples/low_pcode output/v8_bitfield_risky_gate expected --cases case_DFB034 case_DFB035 case_DFB046 case_DFB048 case_DFB049 case_DFB120 case_DFB121 case_DFB122 case_DFB123` | PASS 54 | Bitfield precision remains stable with byte-lane and memory API cases |
| 2026-06-21 | `.venv/bin/python -B tools/pcode_slicegraph_v8_phase1.py samples/low_pcode output/v8_large_struct_regression_gate expected --cases case_DFB050 case_DFB053 case_DFB056 case_DFB057 case_DFB058 case_DFB059` | PASS 36 | Large-struct return-buffer flow passes without regressing existing interprocedural summary cases |
| 2026-06-27 | `.venv/bin/python -B tools/pcode_slicegraph_v8_phase1.py samples/low_pcode output/v8_after_dfb055_risky_gate expected --cases case_DFB020 case_DFB021 case_DFB022 case_DFB023 case_DFB034 case_DFB035 case_DFB040 case_DFB041 case_DFB042 case_DFB043 case_DFB044 case_DFB045 case_DFB046 case_DFB047 case_DFB048 case_DFB049 case_DFB053 case_DFB055 case_DFB120 case_DFB121 case_DFB122 case_DFB123` | PASS 132 | Outparam, bitfield, byte-lane, memory API, large-struct, and nested deep-field focused residuals pass across all roots |
| 2026-06-27 | `.venv/bin/python -B tools/pcode_slicegraph_v8_phase1.py samples/low_pcode output/v8_after_dfb055_full expected --cases` | PASS 403 / FAIL 85 | Full testbed, +33 PASS and 0 regressions against `output/v8_phase2_callout_full`; remaining failures are trusted external helper, recursion-global, indirect/callback, thread/runtime, C++ exception, setjmp/longjmp, and obfuscated state-machine clusters |
