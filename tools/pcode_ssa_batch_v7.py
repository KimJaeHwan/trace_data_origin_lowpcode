...
from pcode_ssa_report_v7 import DEFAULT_EXPECTED_PATH, MemoryObjectTransferSSAEngineV7
...
def write_markdown_summary(summary_path, results, counts):
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("# V7 Low-PCode Batch Expected Validation\n\n")
        f.write("## Summary\n\n")
...
def main():
    parser = argparse.ArgumentParser(description="Batch-run v7 Low-PCode memory-object transfer expected validation.")
    parser.add_argument("input_dir", nargs="?", default="samples/low_pcode")
    parser.add_argument("output_dir", nargs="?", default="output/v7_batch")
